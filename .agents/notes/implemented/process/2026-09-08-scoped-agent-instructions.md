...
| Root: viewer release version | [existing viewer rules](https://github.com/LeonEthan/molly-design/blob/e1db5ccc267a2fad906aaf17067599bf55e340cf/packages/code-review-viewer/AGENTS.md) | Root routes packaging/version changes to the existing, more detailed definition. |
