...
export function createJourneyAuthorTask(input) {
  ...
  const task = {
    ...
    authorInstructions: [
      ...
      `For a ready result, name one unique quoted expectation to replace with ${JSON.stringify(`__MOLLY_COUNTERFACTUAL_${selected.id.replaceAll('-', '_')}__`)} during independent validation.`,
