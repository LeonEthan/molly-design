...
function syntheticWorkspace() {
  return finalizeWorkspace([
    ...
    pkg('@molly/electron', 'apps/electron', {
      deps: [
        '@molly/cli-supervisor',
        '@molly/platform',
        '@molly/shared',
    ...
    pkg('@molly/shared', 'packages/shared', {
      deps: ['acp-extension-core', 'acp-extension-dsh'],
    }),
    pkg('@molly/components', 'packages/components', {
      deps: [
        '@molly/cloud-api',
        '@molly/loro-streams-rpc',
        '@molly/platform',
    ...
    pkg('@molly/platform', 'packages/platform', { deps: ['@molly/shared'] }),
    pkg('@molly/cli-supervisor', 'packages/cli-supervisor', { deps: ['@molly/shared'] }),
...
void test('25. cross-package rename seeds both packages', () => {
  ...
  assertIncludes(scope.seedPackages, ['@molly/platform', '@molly/shared']);
});
