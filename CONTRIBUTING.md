...
| Claude/Codex/Grok/Kimi submodules | Historical probes and upstream provenance                                | Outside default pnpm/CI. Initialize a specific path only for scoped maintenance; Kimi is a separate upstream workspace.        |
