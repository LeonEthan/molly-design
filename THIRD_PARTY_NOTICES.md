...
Generated at: `2026-09-26T09:40:07.365Z`
...
- Bundled assets: 14
- Production dependencies: 1238
- Unique license expressions: 24

## Bundled Assets

### agentic-listing-design adapters
- License: Apache-2.0
- Author: LeonEthan
- Source: https://github.com/LeonEthan/molly-design/blob/main/NOTICE
- Assets: Design authoring and Bento editor adapters
- Notice file: `NOTICE`
- Notes: Rights-holder-owned adapters migrated into Molly, authorized under Apache-2.0 on 2026-09-20. Third-party components retain their own licenses.
### Ayu
- License: MIT
- Author: Ayu Theme
...
- Notes: Bundled VSCode workbench themes used by Molly for theme adaptation.
### vscode-symbols
- License: MIT
...
- Notes: Vendored file and folder icons used across Molly file views.
...
- `type-fest @ 0.13.1, 5.8.0` — https://github.com/sindresorhus/type-fest#readme
...
- `@aws-sdk/signature-v4-multi-region @ 3.996.46` — https://github.com/aws/aws-sdk-js-v3/tree/main/packages/signature-v4-multi-region
  - Author: AWS SDK for JavaScript Team
- `@aws-sdk/token-providers @ 3.1048.0, 3.1129.0` — https://github.com/aws/aws-sdk-js-v3/tree/main/packages/token-providers
  - Author: AWS SDK for JavaScript Team
...
- `@smithy/node-http-handler @ 4.7.3, 4.12.1` — https://github.com/smithy-lang/smithy-typescript/tree/main/packages/node-http-handler
  - Author: AWS SDK for JavaScript Team
  - Description: Provides a way to make requests
...
- `grok-mermaid @ 0.2.2` — https://github.com/xl0/grok-mermaid#readme
...
- `openai @ 6.40.0` — https://github.com/openai/openai-node#readme
  - Author: OpenAI
  - Description: The official TypeScript library for the OpenAI API
- `playwright @ 1.64.0-alpha-1789764292000` — https://playwright.dev
  - Author: Microsoft Corporation
  - Description: A high-level API to automate web browsers
- `playwright-core @ 1.64.0-alpha-1789764292000` — https://playwright.dev
  - Author: Microsoft Corporation
  - Description: A high-level API to automate web browsers
...
- `lru-cache @ 11.2.5` — https://github.com/isaacs/node-lru-cache#readme
  - Author: Isaac Z. Schlueter
...
- `diff @ 8.0.3, 8.0.4` — https://github.com/kpdecker/jsdiff#readme
...
- `saxes @ 6.0.0` — https://github.com/lddubeau/saxes#readme
  ...
  - Description: An evented streaming XML parser in JavaScript
- `semver @ 6.3.1, 7.7.4, 7.8.0, 7.8.5` — https://github.com/npm/node-semver#readme
  - Author: GitHub Inc.
...
- `yallist @ 3.1.1` — https://github.com/isaacs/yallist#readme
  - Author: Isaac Z. Schlueter
  - Description: Yet Another Linked List
- `yaml @ 2.8.2, 2.9.0` — https://eemeli.org/yaml/
  - Author: Eemeli Aro
...
- `@img/sharp-libvips-darwin-arm64 @ 1.3.3` — https://sharp.pixelplumbing.com
  - Author: Lovell Fuller
...
- `@anthropic-ai/sdk @ 0.123.0` — https://github.com/anthropics/anthropic-sdk-typescript#readme
  - Author: Anthropic
...
- `@earendil-works/chord @ 0.85.1` — https://github.com/earendil-works/pi#readme
  - Author: Earendil Works
  - Description: Application composition runtime for services, replicated state, RPC, and plugins
- `@earendil-works/pi-agent-core @ 0.85.1` — https://github.com/earendil-works/pi#readme
  - Author: Mario Zechner
  - Description: General-purpose agent with transport abstraction, state management, and attachment support
- `@earendil-works/pi-ai @ 0.85.1` — https://github.com/earendil-works/pi#readme
  - Author: Mario Zechner
  - Description: Unified LLM API with automatic model discovery and provider configuration
- `@earendil-works/pi-coding-agent @ 0.85.1` — https://github.com/earendil-works/pi#readme
  - Author: Mario Zechner
  - Description: Coding agent CLI with read, bash, edit, write tools and session management
- `@earendil-works/pi-telemetry @ 0.85.1` — https://github.com/earendil-works/pi#readme
  - Author: Mario Zechner
  - Description: Vendor-neutral telemetry contracts and typed schema utilities for pi
- `@earendil-works/pi-tui @ 0.85.1` — https://github.com/earendil-works/pi#readme
  - Author: Mario Zechner
...
- `@esbuild/darwin-arm64 @ 0.25.12, 0.27.0, 0.28.1, 0.28.2` — https://github.com/evanw/esbuild#readme
...
- `@mariozechner/clipboard @ 0.3.9` — https://github.com/badlogic/clipboard#readme
- `@mariozechner/clipboard-darwin-arm64 @ 0.3.9` — https://github.com/badlogic/clipboard#readme
- `@mariozechner/clipboard-darwin-universal @ 0.3.9` — https://github.com/badlogic/clipboard#readme
...
- `@types/retry @ 0.12.0` — https://github.com/DefinitelyTyped/DefinitelyTyped#readme
...
- `bignumber.js @ 9.3.1` — https://github.com/MikeMcl/bignumber.js#readme
...
- `chalk @ 5.6.2` — https://github.com/chalk/chalk#readme
...
- `esbuild @ 0.25.12, 0.27.0, 0.28.1, 0.28.2` — https://github.com/evanw/esbuild#readme
...
- `marked @ 14.0.0, 16.4.2, 17.0.6, 18.0.5` — https://marked.js.org
...
- `p-retry @ 4.6.2` — https://github.com/sindresorhus/p-retry#readme
  - Author: Sindre Sorhus
...
- `remeda @ 2.33.4` — https://remedajs.com/
...
- `rookie-cookies @ 0.6.0` — https://github.com/teng-lin/rookie-cookies#readme
  - Description: Load cookies from any browser on any platform
- `rookie-cookies-darwin-arm64 @ 0.6.0` — https://github.com/teng-lin/rookie-cookies#readme
  - Description: Load cookies from any browser on any platform
...
- `typebox @ 1.3.7` — https://github.com/sinclairzx81/typebox#readme
  - Author: sinclairzx81
...
- `undici @ 8.9.0, 8.10.0` — https://undici.nodejs.org
