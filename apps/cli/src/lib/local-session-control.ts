...
import { LOCAL_MACHINE_RPC_PATH } from '@molly/shared';
import { LOCAL_PROJECT_CONTROL_PATH } from '@molly/shared/node/local-project-control';
import {
  LOCAL_CONTROL_HEADER,
  LOCAL_SESSION_CONTROL_PATH,
  LOCAL_SESSION_CONTROL_STREAM_MEDIA_TYPE,
} from '@molly/shared/node/local-ipc';
import type { LocalSessionControlResponse } from '@molly/shared';
