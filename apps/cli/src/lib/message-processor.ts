import { type LocalSessionControlRequestValidated, SessionId } from '@molly/shared';
...
export class MessageProcessor extends EventEmitter<ProcessorEvents> {
   ...
   * running prompt invokes the Molly MCP upload tool and waits for the response.
   */
