...
import type { PreviewTarget } from '@molly/shared';
import {
...
describe('startPreviewTunnel', () => {
  ...
  it('inlines the visual annotation runtime into decoded compressed HTML responses', async () => {
    ...
    expect(injectedHtml).toContain('data-molly-visual-annotation-runtime="true"');
    expect(injectedHtml).toContain('data-molly-visual-annotation-overlay');
