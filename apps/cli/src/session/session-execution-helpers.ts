import { type IssuePRMention, type ProjectRef } from '@molly/shared';
...
const MOLLY_MCP_TOOLS_REMINDER =
...
export const buildPrompt = (
  ...
  return `${promptWithReferences}${feedbackInstruction}${systemCommands}${MOLLY_MCP_TOOLS_REMINDER}`;
};
