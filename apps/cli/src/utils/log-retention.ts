...
export const MOLLY_LOG_DIR = path.join(getMollyDataDir(), 'logs');
export const MOLLY_LOG_RETENTION_DAYS = 7;
export const MOLLY_LOG_RETENTION_MS = MOLLY_LOG_RETENTION_DAYS * 24 * 60 * 60 * 1000;
export const MOLLY_LOG_RETENTION_MAX_FILES = `${MOLLY_LOG_RETENTION_DAYS}d`;
...
export function cleanupExpiredLogs(
  ...
  const maxAgeMs = options.maxAgeMs ?? MOLLY_LOG_RETENTION_MS;
