...
import type { MessageContent, SessionHistoryInput, SessionId } from '@molly/shared';
...
const runE2E = process.env.MOLLY_E2E === '1';
...
e2eDescribe('acp history e2e (codex stream)', () => {
  ...
  it('captures terminal + diff tool calls and logs flow for inspection', async () => {
    ...
    try {
      ...
      if (process.env.MOLLY_E2E_CAPTURE_FIXTURE === '1') {
