  ...
  it(
    ...
    async () => {
      ...
      const result = await runShim({
        MOLLY_GIT_CRED_BROKER_URL: broker.url,
        MOLLY_GIT_CRED_BROKER_TOKEN: broker.authToken,
        MOLLY_GITHUB_REPO_FULL_NAME: 'loro-dev/lody',
      });
  ...
  it(
    ...
    async () => {
      ...
      const result = await runShim({
        ...
        [MOLLY_MANAGED_GH_TOKEN_SHA256_ENV]: getGhTokenFingerprint(managedToken),
        MOLLY_GIT_CRED_BROKER_URL: broker.url,
        MOLLY_GIT_CRED_BROKER_TOKEN: broker.authToken,
        MOLLY_GITHUB_REPO_FULL_NAME: 'loro-dev/lody',
      });
  ...
  it(
    ...
    async () => {
      ...
      const result = await runShim({
        ...
        MOLLY_GIT_CRED_BROKER_URL: broker.url,
        MOLLY_GIT_CRED_BROKER_TOKEN: broker.authToken,
        MOLLY_GIT_CRED_CONTEXT_TOKEN: 'stale-context',
        MOLLY_GITHUB_REPO_FULL_NAME: 'loro-dev/lody',
      });
