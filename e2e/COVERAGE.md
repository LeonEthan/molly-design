...
| `LODY-SESSION-002`    | Delete a completed Session with Agent resources, preserving the project directory | Work lifecycle        | Real window and IPC           | Real owned runtime | Session cleanup; project directory preserved    | Scripted model |
