...
import type { MollyWorld } from './world.js';

setDefaultTimeout(120_000);

Before(async function (this: MollyWorld, scenario: ITestCaseHookParameter) {
...
After(async function (this: MollyWorld, scenario: ITestCaseHookParameter) {
