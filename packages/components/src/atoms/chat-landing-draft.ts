...
import type { SessionFilePayload, SessionId, SessionImagePayload } from '@molly/shared';
 ...
 * cannot be attached to a session in another. Text and attachments share this scope.
 *
