 ...
 */
export const taskThreadReadAtAtom = atomWithProductStorage<Record<string, number>>(
  'molly-task-thread-read',
  {}
);
...
export const taskVisiblePropertiesAtom = atomWithProductStorage<TaskVisibleProperties>(
  'molly-tasks-visible-properties',
