...
/**
 * Directory picker: a compact desktop dialog body (machine select → browse → confirm).
 */
    ...
    return (
      <StatusPanel
        ...
        description={t(
          ...
          'Connect a machine to this workspace with the Molly CLI to add local projects.'
        )}
      />
    );
  }
...
/**
 * Shell that renders the directory picker as a centered desktop Dialog.
 */
