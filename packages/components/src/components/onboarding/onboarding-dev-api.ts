...
// `window-globals.d.ts`.
//
//   mollyOnboarding.status()       // where am I?
//   mollyOnboarding.restart()      // replay from the ceremony
//   mollyOnboarding.goto('providers')
//   mollyOnboarding.finish()       // clear the renderer phase
...
export function installOnboardingDevApi(): void {
  ...
  (window as unknown as { mollyOnboarding?: OnboardingDevApi }).mollyOnboarding = makeApi();
}
