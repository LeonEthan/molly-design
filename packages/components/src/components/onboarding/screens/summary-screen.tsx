...
import type { ProviderSetupFailureCode } from '@molly/shared';
    ...
    <OnboardingShell
      ...
      primaryAction={
        <OnboardingNextButton
          ...
          label={
            agentState === 'ready'
              ? t('onboarding.summary.open', 'Open Molly')
              : t('onboarding.summary.enter', 'Enter Molly')
          }
        />
      }
    >
  ...
  switch (failureCode) {
    case 'runtime-unavailable':
      return t(
        ...
        'This Agent is not available on the selected machine. Update Molly or choose another machine in Settings.'
      );
    ...
    case 'verification-failed':
      return t(
        ...
        'Molly could not verify this Agent. Check its sign-in or credentials and try again.'
      );
    default:
