...
import type { AgentBrandId, AgentConfigCliType, SessionId, SessionMeta } from '@molly/shared';
...
import { TourLocalBoundary } from './tour-local-boundary';
...
export function TourApp({
  ...
  return (
    <TourLocalBoundary identity={identity}>
