...
import { estimateTokenCount, type SessionMeta, type ConversationMessage } from '@molly/shared';
...
const BACKDROPS: ChatShareCardBackdrop[] = ['none', 'molly', 'aurora', 'ocean', 'sunset', 'welcome'];
...
const BACKDROP_SWATCHES: Record<Exclude<ChatShareCardBackdrop, 'none'>, string> = {
  molly: 'radial-gradient(52% 38% at 18% 12%, rgba(53,200,176,0.45), transparent 70%), radial-gradient(48% 36% at 86% 16%, rgba(47,119,191,0.5), transparent 70%), radial-gradient(70% 55% at 68% 96%, rgba(31,79,127,0.65), transparent 75%), linear-gradient(165deg, #0a1c2b 0%, #0c2438 55%, #081626 100%)',
...
export function ChatShareImageDialog({
  ...
  const [backdrop, setBackdrop] = useState<ChatShareCardBackdrop>('molly');
