...
import { type SessionMeta, type VisualAnnotationReferencePayload } from '@molly/shared';
import {
  createMinimalVisualAnnotationAnchor,
  type VisualAnnotationInspectPayload,
} from '@molly/shared/visual-annotation-inspector';
import {
...
} from '@molly/shared/visual-annotation-types';
import {
  createVisualAnnotationReferenceFromPreviewComment,
  type PreviewVisualComment,
} from '@molly/shared/preview-comment-types';
...
const DRAFT_VISUAL_ANNOTATION_ANCHOR_ID = '__molly_visual_annotation_draft__';
  ...
  return (
    ...
    >
      ...
      isResolvedAnchorVisible(resolvedAnchors[DRAFT_VISUAL_ANNOTATION_ANCHOR_ID], viewport) ? (
        <div
          data-molly-visual-comment-draft="true"
