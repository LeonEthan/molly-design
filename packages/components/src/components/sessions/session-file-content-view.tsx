...
export type SessionFileContentViewProps = {
  ...
  fileProviderRole?: import('@molly/shared').CodeCollabRole;
...
function SessionFileContentViewImpl({
  ...
  // Molly refuses to render some files it can locate perfectly well — too large,
...
type SessionTextMonacoViewerProps = {
  ...
  readonly vscodeTheme: import('@/lib/vscode-theme').MollyResolvedVSCodeTheme | null;
  readonly readOnly: boolean;
  readonly onContentChange?: (text: string) => void;
