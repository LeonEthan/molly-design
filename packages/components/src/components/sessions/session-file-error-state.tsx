import type { CodeCollabContentUnavailableReason } from '@molly/shared';
...
/**
 * Only the errors whose advice is "open it outside Molly" get the actions. On a
    ...
    case 'permission-denied':
      return {
        ...
        description: t(
          ...
          'Molly does not have permission to read this file. Check the file or workspace permissions and try again.'
        ),
      };
    case 'locked':
      return {
    ...
    case 'unknown':
      return {
        ...
        description: t(
          ...
          'Molly could not read this file. Try again, or check the file on the host machine.'
        ),
      };
  }
...
export function getSessionFileErrorPresentation(
  ...
  // file is readable, it is just outside what Molly may read for this session.
  if (
    ...
    return {
      ...
      description: t(
        ...
        'For security, Molly can only read files inside this session’s workspace and Molly’s own temporary directories. Choose a file from the workspace and try again.'
      ),
    };
  }
  ...
  if (
    ...
    return {
      ...
      description: t(
        ...
        'Molly cannot reach the machine that owns this file. Bring the host online and try again.'
      ),
    };
  }
  if (
