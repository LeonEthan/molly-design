import { SESSION_GOAL_COMMANDS, type SessionGoalCommand } from '@molly/shared';

const NO_GOAL_COMMANDS: readonly SessionGoalCommand[] = [];

/**
 * Commands supported by Molly's current `/goal …` prompt bridge.
 *
 ...
 * Molly routes their advertised `_session/goal` extension method.
 */
