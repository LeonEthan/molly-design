            ...
            <div className="rounded-xl border border-border/60 bg-muted/20 p-4">
              <Field
                ...
                hint={t(
                  ...
                  'Advanced: leave empty to let Molly install and verify the managed runtime. Filling this is not recommended unless you need a local enterprise mirror or are debugging runtime startup.'
                )}
                icon={<SquareTerminal className="h-3.5 w-3.5" aria-hidden="true" />}
              >
                <Input
                      ...
                      : usesDefaultManagedRuntime
                        ? backgroundManagedBuiltinSetup
                          ? t(
                              ...
                              'The managed runtime is not downloaded or is out of date. Molly will download and verify it in the background after you add this provider.'
                            )
                          : t(
                              'settings.agent.dialog.managedRuntimeNotInstalled',
                              'The managed runtime is not downloaded or is out of date. Molly will download and verify it before creating this provider.'
                            )
                        : t(
