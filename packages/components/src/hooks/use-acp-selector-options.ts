 ...
 * capabilities. The Molly-owned builtin Grok compatibility options are localized
 * because those strings are synthesized by Molly rather than authored upstream.
 */
