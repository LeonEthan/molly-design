export const ERROR_BOUNDARY_PROBE_STORAGE_KEY = 'molly:error-boundary-probe';
export const ERROR_BOUNDARY_PROBE_QUERY_PARAM = 'molly_error_boundary_probe';
export const ERROR_BOUNDARY_PROBE_STORAGE_ENABLED_VALUE = 'enabled';
export const ERROR_BOUNDARY_PROBE_QUERY_THROW_VALUE = 'throw';
export const ERROR_BOUNDARY_PROBE_EVENT = 'molly:error-boundary-probe';
