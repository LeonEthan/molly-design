...
export const MollyResolvedVSCodeThemeSchema = z
  .object({
...
export type MollyResolvedVSCodeTheme = z.infer<typeof MollyResolvedVSCodeThemeSchema>;
export type MollyResolvedVSCodeThemeType = MollyResolvedVSCodeTheme['type'];
