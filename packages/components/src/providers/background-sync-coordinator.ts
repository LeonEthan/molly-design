import { getSessionRoomId, type SessionId, type SessionStatus } from '@molly/shared';
...
export interface EagerSyncPolicy {
  ...
  maxWarmDocs: number;
  /** Only eager-sync the top-N candidates; bounded on every surface. */
...
export const FULL_EAGER_SYNC_CANDIDATE_WINDOW = 20;
