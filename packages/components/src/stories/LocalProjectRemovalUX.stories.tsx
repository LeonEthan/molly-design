...
import type { LocalProjectId, MachineId, SessionId, SessionMeta } from '@molly/shared';
import { SessionStatusFactory } from '@molly/shared';
...
const project = {
  id: projectId,
  name: 'Molly Desktop',
  rootPath: '/Users/developer/Code/Molly',
...
function DesktopSidebar({
  ...
  return (
    <LoroSidebar
      ...
      workspaces={[{ id: 'workspace-lody', name: 'Molly', planTier: 'plus' }]}
...
function CleanupResult() {
  useEffect(() => {
    ...
    toast.warning('已从 Molly 移除“Molly Desktop”', {
      id,
