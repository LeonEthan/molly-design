...
export const CodeBlocks: Story = {
  args: {
    size: 'default',
    text: [
      'Inline code: `pnpm --filter @molly/components storybook`',
      '',
...
export const CodeBlockPaddingSymmetry: Story = {
  ...
  args: {
    ...
    text: [
      ...
      '',
      '```bash',
      'pnpm --filter @molly/components storybook',
      '```',
      '',
      ...
      '',
      '```ts',
      "const command = 'pnpm --filter @molly/components exec vitest run tests/markdown-streaming-reparse.test.ts --reporter=verbose';",
      '```',
    ].join('\n'),
  },
  parameters: {
...
const allMarkdownFormatsText = [
  ...
  '## Code',
  '',
  'Inline code should stay compact: `pnpm --filter @molly/components storybook`.',
  '',
  ...
  '',
  '```bash',
  'pnpm --filter @molly/components typecheck',
  'pnpm --filter @molly/components exec vitest run tests/markdown-streaming-reparse.test.ts',
  '```',
  '',
  'JSON fenced code:',
  '',
