...
import { applyTextRewrites, type MessageTextSpan } from '@molly/shared';
...
const SENT = applyTextRewrites(COMPOSER_TEXT, [
  ...
  },
  {
    ...
    replacement: 'use molly mcp to query session[id: 9f2c-4a11] history',
    span: { kind: 'session', label: 'CRDT metadata cleanup', target: '9f2c-4a11' },
  },
  {
    ...at('@Code-Reviewer'),
    replacement:
      'use molly mcp to create a session with agent role[id: role-1, name: Code Reviewer]',
