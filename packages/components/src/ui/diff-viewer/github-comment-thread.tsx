...
import type { CommentReferencePayload } from '@molly/shared';
...
function githubSideToMolly(side: 'LEFT' | 'RIGHT'): 'additions' | 'deletions' {
...
export function GitHubCommentThread({
  ...
  const chatReference = useMemo<CommentReferencePayload | null>(() => {
    ...
    return {
      ...
      side: githubSideToMolly(thread.anchor.side),
