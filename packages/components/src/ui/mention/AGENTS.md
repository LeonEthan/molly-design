...
- Narrow desktop windows keep the floating mention menu constrained to the input and viewport.
...
- `mention-input.tsx` owns textarea behavior: trigger detection, virtual caret
  ...
  interaction.
- `mention-content.tsx` renders the floating listbox and provides the input-width CSS variable.
