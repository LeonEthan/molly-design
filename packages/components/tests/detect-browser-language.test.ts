...
afterEach(() => {
  ...
  delete w.__MOLLY_ELECTRON__;
  delete w.__MOLLY_PLATFORM__;
});
...
describe('detectBrowserLanguage', () => {
  ...
  it.each([
    ...
    electronWindow.__MOLLY_ELECTRON__ = true;
    electronWindow.__MOLLY_PLATFORM__ = {
      os,
      homeDir: '/home/test',
  ...
  it('does not fall back to Chromium locale packs when Electron system languages are absent', () => {
    ...
    const electronWindow = window as GlobalWindow;
    electronWindow.__MOLLY_ELECTRON__ = true;
    electronWindow.__MOLLY_PLATFORM__ = { os: 'linux', homeDir: '/home/test' };
