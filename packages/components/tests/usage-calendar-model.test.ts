...
import {
  ...
  createUsageSkylineMollyLogoTriangles,
...
describe('usage calendar model', () => {
  ...
  it('encodes a printable base, Molly logo relief, and twelve triangles for each active column', () => {
    ...
    expect(header).toBe('Molly usage skyline binary STL');
  ...
  it('creates a finite raised Molly logo mesh for the STL base', () => {
    const triangles = createUsageSkylineMollyLogoTriangles();
