...
import { useLocalResourceVisibility } from '../src/hooks/use-local-resource-visibility';
...
type SharingResult = ReturnType<typeof useLocalResourceVisibility>;
...
function Probe({
  ...
  const result = useLocalResourceVisibility(
...
describe('useLocalResourceVisibility project visibility', () => {
