...
export type MollyConversationsLiveActivityIdOptions = {
  workspaceId: string;
  userId: string;
...
export const MOLLY_CONVERSATIONS_LIVE_ACTIVITY_SCHEMA_VERSION = 5;
...
export function buildMollyConversationsLiveActivityId({
  workspaceId,
  userId,
  schemaVersion,
}: MollyConversationsLiveActivityIdOptions): string {
