export const LORO_SIGNATURE_HEADER = 'X-Molly-Signature';
export const LORO_SIGNATURE_TIMESTAMP_HEADER = 'X-Molly-Timestamp';
export const LORO_SIGNATURE_VERSION_HEADER = 'X-Molly-Signature-Version';
