...
export const MOLLY_MACHINE_MONITOR_CHANNEL = 'machine-monitor';
export const MOLLY_MACHINE_MONITOR_STATE_TTL_MS = 30_000;
export const MOLLY_MACHINE_MONITOR_OBSERVER_TTL_MS = 30_000;
export const MOLLY_MACHINE_MONITOR_OBSERVER_RENEW_MS = 15_000;
export const MOLLY_MACHINE_MONITOR_UNIX_SAMPLE_MS = 2_000;
export const MOLLY_MACHINE_MONITOR_MACOS_SAMPLE_MS = 5_000;
export const MOLLY_MACHINE_MONITOR_WINDOWS_SAMPLE_MS = 5_000;
export const MOLLY_MACHINE_MONITOR_STALE_MS = 10_000;
...
export const toMollyMachineMonitorStreamUrl = (durableStreamUrl: string): string => {
  const url = new URL(durableStreamUrl);
  url.searchParams.set('ephemeral', MOLLY_MACHINE_MONITOR_CHANNEL);
  return url.toString();
};
