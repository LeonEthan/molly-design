...
export type MachineAcpAuthenticateRequest = MachineAcpAuthenticateRequestBase &
  (
    ...
    | {
        ...
        authenticationRequestId: string;
        /** One-time provider input; never log or copy it into durable Molly product state. */
 ...
 * with the user's bug description to the Molly backend. The machine responds
