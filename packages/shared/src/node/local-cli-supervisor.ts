export const MOLLY_SUPERVISOR_PID_ENV = 'MOLLY_SUPERVISOR_PID';
export const MOLLY_SUPERVISOR_INSTANCE_ID_ENV = 'MOLLY_SUPERVISOR_INSTANCE_ID';
export const MOLLY_SUPERVISOR_TOKEN_ENV = 'MOLLY_SUPERVISOR_TOKEN';
export const MOLLY_SUPERVISOR_CONTRACT_ENV = 'MOLLY_SUPERVISOR_CONTRACT';
