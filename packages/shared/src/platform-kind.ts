/** Build/launch-time product assembly. Kept below @molly/platform so Node-only
 * state and IPC helpers can select an installation namespace without creating
 * a dependency cycle. */
export type PlatformKind = 'local' | 'cloud';

export const PLATFORM_ENV_VAR = 'MOLLY_PLATFORM';
export const PLATFORM_VITE_ENV_VAR = 'VITE_MOLLY_PLATFORM';
