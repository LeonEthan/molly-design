 ...
 * through `molly_report_preview_candidate`, so `none`/`invalid` candidates (the
...
// The Molly web app embedder runs under `Cross-Origin-Embedder-Policy: credentialless`
