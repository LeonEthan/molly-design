export const STATIC_HTML_PREVIEW_DOCUMENT_MARKER = 'data-molly-static-html-preview-document';
...
(function () {
  ...
  var BROWSER_COMMAND = "MOLLY_MANAGED_BROWSER_COMMAND";
  var BROWSER_STATE = "MOLLY_MANAGED_BROWSER_STATE";
  var BROWSER_NAVIGATION_REQUEST = "MOLLY_MANAGED_BROWSER_NAVIGATION_REQUEST";
  ...
  var OVERLAY_ATTR = "data-molly-visual-annotation-overlay";
  var INTERACTION_LAYER_ATTR = "data-molly-visual-annotation-interaction-layer";
  ...
  function warn(message) {
    if (window.console && typeof window.console.warn === "function") {
      window.console.warn("[Molly visual annotation] " + message);
    }
  }
