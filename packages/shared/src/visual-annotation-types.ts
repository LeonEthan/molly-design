...
export const MANAGED_BROWSER_COMMAND_MESSAGE_TYPE = 'MOLLY_MANAGED_BROWSER_COMMAND' as const;
export const MANAGED_BROWSER_STATE_MESSAGE_TYPE = 'MOLLY_MANAGED_BROWSER_STATE' as const;
export const MANAGED_BROWSER_NAVIGATION_REQUEST_MESSAGE_TYPE =
  'MOLLY_MANAGED_BROWSER_NAVIGATION_REQUEST' as const;
