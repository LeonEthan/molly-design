...
describe('acp history apply', () => {
  ...
  it('strips Molly internal system instructions from assistant text before history storage', () => {
    const notifications = [
      makeNotification({
        sessionUpdate: 'agent_message_chunk',
        content: {
  ...
  it('strips Molly internal system instructions after streamed text chunks are merged', () => {
    const notifications = [
      makeNotification({
        sessionUpdate: 'agent_message_chunk',
        content: {
  ...
  it('does not create history for assistant text that only contains Molly internal instructions', () => {
    const notifications = [
      makeNotification({
        sessionUpdate: 'agent_message_chunk',
        content: {
  ...
  it('strips Molly internal system instructions from direct message-content batches', () => {
