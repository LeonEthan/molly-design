 ...
 *   pnpm --filter @molly/turn-diff-store bench
 *   pnpm --filter @molly/turn-diff-store bench -- --turns=40 --files=8 --file-kib=512
 *   pnpm --filter @molly/turn-diff-store bench -- --worker=apps/cli/dist/turn-diff-store-worker.js
 */
