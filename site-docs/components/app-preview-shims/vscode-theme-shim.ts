...
export type MollyResolvedVSCodeTheme = Record<string, unknown>;
...
export const createMollyVSCodeShikiThemeName = (..._args: unknown[]): string => 'lody';
...
export const getCachedBundledVSCodeThemes = (..._args: unknown[]): readonly unknown[] | undefined =>
  undefined;
export const getRegisteredMollyVSCodeThemeForDiffs = (..._args: unknown[]): undefined => undefined;
...
export const registerMollyVSCodeThemeForDiffs = (..._args: unknown[]): void => {};
