...
declare module '@/components/chat/visual-annotation-reference-chip' {
  import type { VisualAnnotationReferencePayload } from '@molly/shared';
...
declare module '@/components/sessions/floating-permission-request' {
  import type { ReactElement } from 'react';
  import type { SessionDoc, SessionId, SessionStatus } from '@molly/shared';
...
declare module '@/components/ai-gui/view' {
  import type { ReactElement, ReactNode } from 'react';
  import type { SessionHistoryParsed, SessionId } from '@molly/shared';
